...
class vehicle5 extends StatefulWidget {
  const vehicle5({super.key});

  @override
  State<vehicle5> createState() => _vehicle5State();
}

class _vehicle5State extends State<vehicle5> {
  ...
  Future<void> _pickImage3() async {
    ...
    if (pickedImage3 != null) {
      setState(() {
        _image3 = pickedImage3;
        frontProfile = _image3;
      });
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              PageRouteBuilder(
                                pageBuilder: (_, __, ___) => const vehicle3(),
                    ...
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Image.asset("assets/images/vehicle_step2.png"),
                        ),
                      ],
                    ),
                    const SizedBox(
                    ...
                    const Text(
                      "Capture your selfie for video KYC to proceed further to next Step.",
                      style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w400,
              ...
              child: TextButton(
                onPressed: () {
                  if (_image3 == null) {
                    ...
                    Navigator.push(
                        context, MaterialPageRoute(builder: (_) => vehicle4()));
                  }
                },
                child: Container(
